	...
	<nav class="navbar navbar-expand-md navbar-dark" style="background-color: #007BFF;">
		 <div>
		 	<a href="https://github.com/CarlosRobertoMedeiros/study-JavaEE" class="navbar-brand"> App Exemplo</a>
		 </div>
		
		 <ul class="navbar-nav navbar-collapse justify-content-end">
			 <li><a href="<%= request.getContextPath() %>/login" class="nav-link">Logar</a></li>
			 <li><a href="<%= request.getContextPath() %>/registrar" class="nav-link">Registrar</a></li>
		 </ul>
	</nav>
	-->
...
<nav class="navbar navbar-default navbar-expand-lg navbar-light">
	...
	<div class="navbar-header d-flex col">
		<a class="navbar-brand" href="#">App Exemplo <b>Servlet</b></a>  		
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		...
		<form class="navbar-form form-inline">
			<div class="input-group search-box">								
				<input type="text" id="search" class="form-control form-controle" placeholder="Search here...">
					...
					<li>
						<form action="/examples/actions/confirmation.php" method="post">
							...
							<div class="form-group social-btn clearfix">
								<a href="#" class="btn btn-primary pull-left"><i class="fa fa-google"></i>Google</a>
...
<!-- 
 ...
 -->
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<!-- Lista todo o Header -->
		<a class="navbar-brand" href="#">Sistema Exemplo <b style="color: blue;">Servlet</b></a>
		...
		<ul class="nav navbar-nav navbar-right ml-auto">
			...
			<li class="nav-item">
				<a data-toggle="dropdown" class="nav-link dropdown-toggle" href="#">Registar</a>
				<ul class="dropdown-menu">	
			...
			<!-- Fim do Formulario de Cadastro de Usuário -->
